...
<head>
    ...
    <title>Create account — AI Health Intelligence</title>
...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm mt-1">Start your AI health intelligence journey</p>
    </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">
                    Organization / Clinic
                    <span class="text-gray-400 font-normal text-xs">(or your name if personal use)</span>
                </label>
            ...
            <button type="submit"
                    class="w-full py-2.5 px-4 font-medium rounded-lg text-sm text-white transition-colors mt-2"
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        ...
        <a href="{{ route('login') }}" class="text-emerald-600 hover:underline font-medium">Sign in</a>
    </p>

    <p class="text-center text-xs text-gray-400 mt-4 px-4">
        This platform provides informational insights only and is not a substitute for professional medical advice.
    </p>
