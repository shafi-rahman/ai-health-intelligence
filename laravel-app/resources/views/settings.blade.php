...
<div class="px-8 py-6 bg-white border-b border-gray-200 flex-shrink-0">
    ...
    <p class="text-gray-500 text-sm mt-0.5">Configure your AI health assistant and manage your account.</p>
</div>
...
<div class="flex-1 px-8 py-6 space-y-6 max-w-2xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            ...
            <p class="text-sm text-gray-500 mt-0.5">Set the default model and persona for your health AI.</p>
        </div>
        ...
        <form method="POST" action="{{ route('settings.update') }}" class="px-6 py-5 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-2" id="modelGrid">
                    @php
                        $models = [
                            ...
                            'gemma4' => ['label' => 'Gemma 4', 'desc' => '8B · Best Quality'],
                        ];
            ...
            <div>
                ...
                <textarea id="system_prompt" name="system_prompt" rows="4"
                          placeholder="e.g. You are a personal health AI assistant. Help me understand my medical reports and prescriptions. Always include a disclaimer that this is not medical advice."
                ...
                <p class="text-xs text-gray-400 mt-1.5">Sent to the AI before every health chat session. Leave blank to use the built-in health AI prompt.</p>
            </div>
